...
export const jrRyomoline: Station[] = [
  ...
  { name: "岩舟",       lat: 36.326680, lng: 139.657724, timeToNext: 8 },
...
export const jrMitoLineExt: Station[] = [
  { name: "友部",       lat: 36.350798, lng: 140.306289, timeToNext: 5 },
...
export const jrKarasuyamaLine: Station[] = [
  ...
  { name: "鴻野山",     lat: 36.666438, lng: 140.051676, timeToNext: 5 },
  { name: "大金",       lat: 36.656447, lng: 140.095639, timeToNext: 5 },
  { name: "小塙",       lat: 36.642957, lng: 140.116850, timeToNext: 5 },
  { name: "滝",         lat: 36.648552, lng: 140.138426, timeToNext: 5 },
...
export const jrKururiLine: Station[] = [
  ...
  { name: "上総清川",   lat: 35.390949, lng: 139.965540, timeToNext: 5 },
  { name: "東清川",     lat: 35.390016, lng: 139.985803, timeToNext: 5 },
  { name: "横田",       lat: 35.386109, lng: 140.020341, timeToNext: 5 },
  { name: "東横田",     lat: 35.386268, lng: 140.036446, timeToNext: 5 },
  { name: "馬来田",     lat: 35.366675, lng: 140.058687, timeToNext: 5 },
  { name: "下郡",       lat: 35.355345, lng: 140.055442, timeToNext: 5 },
  { name: "久留里",     lat: 35.295846, lng: 140.07575, timeToNext: 10 },
  { name: "平山",       lat: 35.274359, lng: 140.064867, timeToNext: 5 },
  { name: "上総松丘",   lat: 35.257796, lng: 140.063998, timeToNext: 5 },
...
export const jrSobuMainLine: Station[] = [
  ...
  { name: "榎戸",       lat: 35.683777, lng: 140.288477, timeToNext: 10 },
