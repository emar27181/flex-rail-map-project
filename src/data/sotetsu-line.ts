...
export const sotetsuMainLine: Station[] = [
  { name: "横浜", lat: 35.4657, lng: 139.6227, timeToNext: 2 },
  { name: "平沼橋", lat: 35.4653, lng: 139.6152, timeToNext: 2 },
  { name: "西横浜", lat: 35.4591, lng: 139.6048, timeToNext: 2 },
  { name: "天王町", lat: 35.4508, lng: 139.5965, timeToNext: 2 },
  { name: "星川", lat: 35.4461, lng: 139.5859, timeToNext: 2 },
  { name: "和田町", lat: 35.4425, lng: 139.5769, timeToNext: 2 },
  { name: "上星川", lat: 35.4418, lng: 139.5663, timeToNext: 2 },
  { name: "西谷", lat: 35.4376, lng: 139.5515, timeToNext: 3 },
  { name: "鶴ヶ峰", lat: 35.4523, lng: 139.5345, timeToNext: 3 },
...
export const sotetsuIzumino: Station[] = [
  { name: "二俣川", lat: 35.4589, lng: 139.5178, timeToNext: 3 },
  { name: "南万騎が原", lat: 35.4489, lng: 139.5123, timeToNext: 2 },
  { name: "緑園都市", lat: 35.4378, lng: 139.5034, timeToNext: 3 },
