...
export const jrHakodateMainLine: Station[] = [
  ...
  { name: "桑園",     lat: 43.074920, lng: 141.338660, timeToNext: 3 },
  { name: "琴似",     lat: 43.073110, lng: 141.308900, timeToNext: 4 },
  { name: "発寒中央",  lat: 43.073480, lng: 141.286260, timeToNext: 3 },
  { name: "発寒",     lat: 43.073110, lng: 141.267930, timeToNext: 4 },
  { name: "稲積公園",  lat: 43.094510, lng: 141.250690, timeToNext: 4 },
  { name: "手稲",     lat: 43.116400, lng: 141.224720, timeToNext: 5 },
  { name: "星置",     lat: 43.120970, lng: 141.193290, timeToNext: 4 },
  { name: "ほしみ",   lat: 43.126810, lng: 141.165770, timeToNext: 20 },
  { name: "小樽",     lat: 43.195220, lng: 140.995550, timeToNext: 12 },
  { name: "南小樽",   lat: 43.191010, lng: 140.990420, timeToNext: 7 },
  { name: "小樽築港",  lat: 43.179170, lng: 140.990080, timeToNext: 15 },
  { name: "余市",     lat: 43.197130, lng: 140.771830, timeToNext: 25 },
  { name: "仁木",     lat: 43.192070, lng: 140.722000, timeToNext: 15 },
  { name: "然別",     lat: 43.319650, lng: 140.843920, timeToNext: 20 },
  { name: "岩見沢",   lat: 43.196760, lng: 141.775990, timeToNext: 25 },
  { name: "美唄",     lat: 43.337280, lng: 141.843770, timeToNext: 15 },
  { name: "砂川",     lat: 43.493550, lng: 141.896060, timeToNext: 12 },
  { name: "滝川",     lat: 43.556830, lng: 141.919530, timeToNext: 18 },
  { name: "深川",     lat: 43.717190, lng: 142.055070, timeToNext: 15 },
  { name: "旭川",     lat: 43.770070, lng: 142.363540, timeToNext: 0 },
];
