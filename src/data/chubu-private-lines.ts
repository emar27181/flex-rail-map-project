...
export const meitetsuTokonameLine: Station[] = [
  ...
  { name: "名和",      lat: 35.024870, lng: 136.926700, timeToNext: 4 },
  { name: "聚楽園",    lat: 35.002530, lng: 136.925310, timeToNext: 4 },
  { name: "新舞子",    lat: 34.984660, lng: 136.916020, timeToNext: 4 },
  { name: "大野町",    lat: 34.955100, lng: 136.896380, timeToNext: 4 },
  { name: "西ノ口",    lat: 34.930560, lng: 136.863750, timeToNext: 4 },
...
export const meitetsuInuyamaLine: Station[] = [
  ...
  { name: "中小田井",   lat: 35.195200, lng: 136.842560, timeToNext: 3 },
  { name: "上小田井",   lat: 35.208000, lng: 136.846110, timeToNext: 3 },
  { name: "西春",      lat: 35.222820, lng: 136.844430, timeToNext: 3 },
  { name: "徳重・名古屋芸大", lat: 35.236380, lng: 136.843060, timeToNext: 3 },
  { name: "大山寺",    lat: 35.250290, lng: 136.841420, timeToNext: 4 },
  { name: "岩倉",      lat: 35.279950, lng: 136.872150, timeToNext: 5 },
  { name: "石仏",      lat: 35.305650, lng: 136.905510, timeToNext: 4 },
  { name: "布袋",      lat: 35.319050, lng: 136.895390, timeToNext: 4 },
  { name: "江南",      lat: 35.333240, lng: 136.872010, timeToNext: 4 },
  { name: "柏森",      lat: 35.355830, lng: 136.859820, timeToNext: 4 },
  { name: "扶桑",      lat: 35.369030, lng: 136.852830, timeToNext: 4 },
  { name: "木津用水",   lat: 35.387430, lng: 136.859320, timeToNext: 4 },
...
export const kintetsuNagoyaLine: Station[] = [
  ...
  { name: "近鉄弥富",   lat: 35.094740, lng: 136.771740, timeToNext: 5 },
  { name: "佐古木",    lat: 35.113510, lng: 136.736070, timeToNext: 5 },
  { name: "近鉄長島",   lat: 35.109290, lng: 136.740990, timeToNext: 5 },
  ...
  { name: "川原町",    lat: 34.935570, lng: 136.620990, timeToNext: 5 },
  ...
  { name: "千代崎",    lat: 34.876850, lng: 136.662810, timeToNext: 5 },
  { name: "白子",      lat: 34.863770, lng: 136.670450, timeToNext: 5 },
  { name: "鼓ヶ浦",    lat: 34.842380, lng: 136.648910, timeToNext: 5 },
  { name: "磯山",      lat: 34.822710, lng: 136.636060, timeToNext: 5 },
  { name: "伊勢若松",   lat: 34.803670, lng: 136.647660, timeToNext: 5 },
  { name: "玉垣",      lat: 34.799700, lng: 136.640080, timeToNext: 5 },
  { name: "高茶屋",    lat: 34.754060, lng: 136.556090, timeToNext: 5 },
  { name: "六軒",      lat: 34.733810, lng: 136.537260, timeToNext: 5 },
  { name: "伊勢中川",   lat: 34.714600, lng: 136.496600, timeToNext: 0 },
];
