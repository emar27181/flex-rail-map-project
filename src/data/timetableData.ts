 ...
 * 時刻表データ全体の出典。
 *
 * ここで扱う発車時刻は、各社が公表している時間帯別の運行間隔から
 * 生成した概算であり、公式時刻表そのものを取り込んだものではない。
 * 画面にもこの但し書きを出して、利用者が実時刻と取り違えないようにする。
 */
export const TIMETABLE_SOURCE = {
  /** 出典の要約（UI表示用） */
  title: '各鉄道会社が公表する運行間隔をもとにした概算',
  /** 基準としたダイヤ改正 */
  referenceRevision: '2025年3月15日ダイヤ改正',
  /** 詳細な但し書き */
  note: '公式時刻表そのものではなく、時間帯ごとの運行間隔から発車時刻を組み立てた参考値です。正確な時刻は各鉄道会社の公式時刻表をご確認ください。',
} as const;
  ...
  directions: [
    {
      label: '上野→宇都宮方面',
      stations: [
        { name: '上野', offset: 5 }, { name: '赤羽', offset: 14 },
    ...
    },
    {
      ...
      patterns: [
        { fromMin: m(5),  toMin: m(7),    intervalMin: 20, type: '普通', destination: '上野・東京方面' },
        { fromMin: m(7),  toMin: m(9),    intervalMin: 15, type: '普通', destination: '上野・東京方面' },
        { fromMin: m(9),  toMin: m(17),   intervalMin: 20, type: '普通', destination: '上野・東京方面' },
        { fromMin: m(17), toMin: m(20),   intervalMin: 15, type: '普通', destination: '上野・東京方面' },
        { fromMin: m(20), toMin: m(23),   intervalMin: 20, type: '普通', destination: '上野・東京方面' },
      ],
    },
  ],
};
  ...
  directions: [
    ...
    },
    {
      ...
      stations: [
        ...
        { name: '有明テニスの森', offset: 7 }, { name: '有明', offset: 9 },
  ...
  directions: [
    {
      ...
      stations: [
        ...
        { name: '京成成田', offset: 97 }, { name: '東成田', offset: 102 }, { name: '成田空港', offset: 108 },
      ],
      patterns: [
  ...
  directions: [
    {
      label: '立川→川崎方面',
      stations: [
        { name: '立川', offset: 0 }, { name: '西国立', offset: 3 },
    ...
    },
    {
      ...
      stations: [
        ...
        { name: '矢川', offset: 54 }, { name: '西国立', offset: 59 },
        { name: '立川', offset: 62 },
      ],
      patterns: [
...
// 江ノ島電鉄（藤沢〜鎌倉）
const enoshimaDentetsuData: LineTimetableData = {
  ...
  directions: [
    {
      ...
      stations: [
        ...
        { name: '由比ヶ浜', offset: 24 }, { name: '和田塚', offset: 26 }, { name: '鎌倉', offset: 30 },
      ],
      patterns: [
        { fromMin: m(6),    toMin: m(9),    intervalMin: 12, type: '普通', destination: '鎌倉' },
        { fromMin: m(9),    toMin: m(19),   intervalMin: 10, type: '普通', destination: '鎌倉' },
        { fromMin: m(19),   toMin: m(22),   intervalMin: 12, type: '普通', destination: '鎌倉' },
        { fromMin: m(22),   toMin: m(23,30),intervalMin: 20, type: '普通', destination: '鎌倉' },
      ],
    },
    {
      label: '藤沢方面',
      stations: [
        { name: '鎌倉', offset: 0 }, { name: '和田塚', offset: 4 }, { name: '由比ヶ浜', offset: 6 },
        { name: '長谷', offset: 8 }, { name: '極楽寺', offset: 10 }, { name: '稲村ヶ崎', offset: 12 },
        { name: '七里ヶ浜', offset: 14 }, { name: '鎌倉高校前', offset: 16 }, { name: '腰越', offset: 18 },
        { name: '江ノ島', offset: 20 }, { name: '湘南海岸公園', offset: 22 }, { name: '鵠沼', offset: 24 },
        { name: '柳小路', offset: 26 }, { name: '石上', offset: 28 }, { name: '藤沢', offset: 30 },
      ],
      patterns: [
        { fromMin: m(6),    toMin: m(9),    intervalMin: 12, type: '普通', destination: '藤沢' },
        { fromMin: m(9),    toMin: m(19),   intervalMin: 10, type: '普通', destination: '藤沢' },
        { fromMin: m(19),   toMin: m(22),   intervalMin: 12, type: '普通', destination: '藤沢' },
        { fromMin: m(22),   toMin: m(23,30),intervalMin: 20, type: '普通', destination: '藤沢' },
      ],
    },
  ],
};
...
// 都電荒川線（早稲田〜三ノ輪橋）
const todenArakawaData: LineTimetableData = {
  ...
  directions: [
    {
      ...
      stations: [
        ...
        { name: '熊野前', offset: 42 }, { name: '町屋二丁目', offset: 46 },
      ...
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 8,  type: '普通', destination: '三ノ輪橋' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 6,  type: '普通', destination: '三ノ輪橋' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 7,  type: '普通', destination: '三ノ輪橋' },
        { fromMin: m(17),   toMin: m(19),   intervalMin: 6,  type: '普通', destination: '三ノ輪橋' },
        { fromMin: m(19),   toMin: m(22,30),intervalMin: 8,  type: '普通', destination: '三ノ輪橋' },
        { fromMin: m(22,30),toMin: m(24),   intervalMin: 12, type: '普通', destination: '三ノ輪橋' },
      ],
    },
    {
      label: '早稲田方面',
      stations: [
        ...
        { name: '町屋二丁目', offset: 12 }, { name: '熊野前', offset: 16 },
      ...
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 8,  type: '普通', destination: '早稲田' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 6,  type: '普通', destination: '早稲田' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 7,  type: '普通', destination: '早稲田' },
        { fromMin: m(17),   toMin: m(19),   intervalMin: 6,  type: '普通', destination: '早稲田' },
        { fromMin: m(19),   toMin: m(22,30),intervalMin: 8,  type: '普通', destination: '早稲田' },
        { fromMin: m(22,30),toMin: m(24),   intervalMin: 12, type: '普通', destination: '早稲田' },
      ],
    },
  ],
};
...
// 東急世田谷線（三軒茶屋〜下高井戸）
const tokyuSetagayaData: LineTimetableData = {
  ...
  directions: [
    {
      ...
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 12, type: '普通', destination: '下高井戸' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 8,  type: '普通', destination: '下高井戸' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 10, type: '普通', destination: '下高井戸' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 8,  type: '普通', destination: '下高井戸' },
        { fromMin: m(20),   toMin: m(23,30),intervalMin: 10, type: '普通', destination: '下高井戸' },
      ],
    },
    {
      label: '三軒茶屋方面',
      ...
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 12, type: '普通', destination: '三軒茶屋' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 8,  type: '普通', destination: '三軒茶屋' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 10, type: '普通', destination: '三軒茶屋' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 8,  type: '普通', destination: '三軒茶屋' },
        { fromMin: m(20),   toMin: m(23,30),intervalMin: 10, type: '普通', destination: '三軒茶屋' },
      ],
    },
  ],
};
...
// 京急久里浜線（堀ノ内〜三崎口）
const keikyuKurihamaData: LineTimetableData = {
  ...
  directions: [
    {
      label: '三崎口方面',
      stations: [
        { name: '堀ノ内', offset: 0 }, { name: '新大津', offset: 2 }, { name: '北久里浜', offset: 5 },
        { name: '京急久里浜', offset: 8 }, { name: 'YRP野比', offset: 11 }, { name: '京急長沢', offset: 14 },
        { name: '津久井浜', offset: 17 }, { name: '三浦海岸', offset: 20 }, { name: '三崎口', offset: 24 },
      ],
      patterns: [
        { fromMin: m(6),    toMin: m(9),    intervalMin: 20, type: '普通', destination: '三崎口' },
        { fromMin: m(9),    toMin: m(18),   intervalMin: 20, type: '普通', destination: '三崎口' },
        { fromMin: m(18),   toMin: m(22),   intervalMin: 20, type: '普通', destination: '三崎口' },
        { fromMin: m(22),   toMin: m(23,30),intervalMin: 30, type: '普通', destination: '三崎口' },
      ],
    },
    {
      label: '堀ノ内方面',
      stations: [
        { name: '三崎口', offset: 0 }, { name: '三浦海岸', offset: 4 }, { name: '津久井浜', offset: 7 },
        { name: '京急長沢', offset: 10 }, { name: 'YRP野比', offset: 13 }, { name: '京急久里浜', offset: 16 },
        { name: '北久里浜', offset: 19 }, { name: '新大津', offset: 22 }, { name: '堀ノ内', offset: 24 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(9),    intervalMin: 20, type: '普通', destination: '堀ノ内' },
        { fromMin: m(9),    toMin: m(18),   intervalMin: 20, type: '普通', destination: '堀ノ内' },
        { fromMin: m(18),   toMin: m(22),   intervalMin: 20, type: '普通', destination: '堀ノ内' },
        { fromMin: m(22),   toMin: m(23,30),intervalMin: 30, type: '普通', destination: '堀ノ内' },
      ],
    },
  ],
};
...
// 京急空港線（京急蒲田〜羽田空港）
const keikyuAirportData: LineTimetableData = {
  ...
  directions: [
    {
      ...
      patterns: [
        { fromMin: m(5),    toMin: m(7),    intervalMin: 12, type: '普通', destination: '羽田空港第1・第2ターミナル' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 8,  type: 'エアポート急行', destination: '羽田空港第1・第2ターミナル' },
        { fromMin: m(9),    toMin: m(18),   intervalMin: 10, type: 'エアポート急行', destination: '羽田空港第1・第2ターミナル' },
        { fromMin: m(18),   toMin: m(21),   intervalMin: 8,  type: 'エアポート急行', destination: '羽田空港第1・第2ターミナル' },
        { fromMin: m(21),   toMin: m(24),   intervalMin: 12, type: '普通', destination: '羽田空港第1・第2ターミナル' },
      ],
    },
    {
      label: '京急蒲田方面',
      ...
      patterns: [
        { fromMin: m(5),    toMin: m(7),    intervalMin: 12, type: '普通', destination: '京急蒲田' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 8,  type: 'エアポート急行', destination: '京急蒲田' },
        { fromMin: m(9),    toMin: m(18),   intervalMin: 10, type: 'エアポート急行', destination: '京急蒲田' },
        { fromMin: m(18),   toMin: m(21),   intervalMin: 8,  type: 'エアポート急行', destination: '京急蒲田' },
        { fromMin: m(21),   toMin: m(24),   intervalMin: 12, type: '普通', destination: '京急蒲田' },
      ],
    },
  ],
};
...
// 京成押上線（押上〜青砥）
const keiseiOshiageData: LineTimetableData = {
  ...
  directions: [
    {
      ...
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 10, type: '普通', destination: '青砥' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 6,  type: '普通', destination: '青砥' },
        { fromMin: m(9),    toMin: m(18),   intervalMin: 8,  type: '普通', destination: '青砥' },
        { fromMin: m(18),   toMin: m(21),   intervalMin: 6,  type: '普通', destination: '青砥' },
        { fromMin: m(21),   toMin: m(23,30),intervalMin: 10, type: '普通', destination: '青砥' },
      ],
    },
    {
      label: '押上方面',
      ...
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 10, type: '普通', destination: '押上' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 6,  type: '普通', destination: '押上' },
        { fromMin: m(9),    toMin: m(18),   intervalMin: 8,  type: '普通', destination: '押上' },
        { fromMin: m(18),   toMin: m(21),   intervalMin: 6,  type: '普通', destination: '押上' },
        { fromMin: m(21),   toMin: m(23,30),intervalMin: 10, type: '普通', destination: '押上' },
      ],
    },
  ],
};
...
// 北総鉄道（京成高砂〜印旛日本医大）
const hokusouData: LineTimetableData = {
  key: 'hokusouLine',
  name: '北総鉄道',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      ...
      stations: [
        ...
        { name: '松飛台', offset: 19 }, { name: '大町', offset: 22 }, { name: '新鎌ヶ谷', offset: 26 },
        { name: '西白井', offset: 30 }, { name: '白井', offset: 34 }, { name: '小室', offset: 38 },
        { name: '千葉ニュータウン中央', offset: 42 }, { name: '印西牧の原', offset: 47 }, { name: '印旛日本医大', offset: 52 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(8),    intervalMin: 20, type: '普通', destination: '印旛日本医大' },
        { fromMin: m(8),    toMin: m(9),    intervalMin: 15, type: '普通', destination: '印旛日本医大' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 20, type: '普通', destination: '印旛日本医大' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 15, type: '普通', destination: '印旛日本医大' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 20, type: '普通', destination: '印旛日本医大' },
      ],
    },
    {
      label: '京成高砂方面',
      stations: [
        { name: '印旛日本医大', offset: 0 }, { name: '印西牧の原', offset: 5 }, { name: '千葉ニュータウン中央', offset: 10 },
        { name: '小室', offset: 14 }, { name: '白井', offset: 18 }, { name: '西白井', offset: 22 },
        { name: '新鎌ヶ谷', offset: 26 }, { name: '大町', offset: 30 }, { name: '松飛台', offset: 33 },
        { name: '東松戸', offset: 36 }, { name: '秋山', offset: 39 }, { name: '北国分', offset: 42 },
        { name: '矢切', offset: 45 }, { name: '新柴又', offset: 48 }, { name: '京成高砂', offset: 52 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(8),    intervalMin: 20, type: '普通', destination: '京成高砂' },
        { fromMin: m(8),    toMin: m(9),    intervalMin: 15, type: '普通', destination: '京成高砂' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 20, type: '普通', destination: '京成高砂' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 15, type: '普通', destination: '京成高砂' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 20, type: '普通', destination: '京成高砂' },
      ],
    },
  ],
};
...
// 埼玉高速鉄道（赤羽岩淵〜浦和美園）
const saitamaRailwayData: LineTimetableData = {
  key: 'saitamaRailway',
  name: '埼玉高速鉄道',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      ...
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 12, type: '普通', destination: '浦和美園' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 8,  type: '普通', destination: '浦和美園' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 10, type: '普通', destination: '浦和美園' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 8,  type: '普通', destination: '浦和美園' },
        { fromMin: m(20),   toMin: m(23,30),intervalMin: 12, type: '普通', destination: '浦和美園' },
      ],
    },
    {
      label: '赤羽岩淵方面',
      ...
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 12, type: '普通', destination: '赤羽岩淵' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 8,  type: '普通', destination: '赤羽岩淵' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 10, type: '普通', destination: '赤羽岩淵' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 8,  type: '普通', destination: '赤羽岩淵' },
        { fromMin: m(20),   toMin: m(23,30),intervalMin: 12, type: '普通', destination: '赤羽岩淵' },
      ],
    },
  ],
};
...
// ニューシャトル（大宮〜内宿）
const newShuttleData: LineTimetableData = {
  key: 'newShuttle',
  name: 'ニューシャトル',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      ...
      patterns: [
        { fromMin: m(6),    toMin: m(9),    intervalMin: 15, type: '普通', destination: '内宿' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 15, type: '普通', destination: '内宿' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 15, type: '普通', destination: '内宿' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 20, type: '普通', destination: '内宿' },
      ],
    },
    {
      label: '大宮方面',
      ...
      patterns: [
        { fromMin: m(6),    toMin: m(9),    intervalMin: 15, type: '普通', destination: '大宮' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 15, type: '普通', destination: '大宮' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 15, type: '普通', destination: '大宮' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 20, type: '普通', destination: '大宮' },
      ],
    },
  ],
};
...
// 相鉄・JR直通線（海老名〜新宿）
const sotetsuJRData: LineTimetableData = {
  key: 'sotetsuJRLine',
  name: '相鉄・JR直通線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      ...
      stations: [
        ...
        { name: '西谷', offset: 27 }, { name: '羽沢横浜国大', offset: 31 }, { name: '武蔵小杉', offset: 39 },
        { name: '西大井', offset: 44 }, { name: '大崎', offset: 48 }, { name: '恵比寿', offset: 51 },
        { name: '渋谷', offset: 55 }, { name: '新宿', offset: 59 },
      ],
      patterns: [
        { fromMin: m(6),    toMin: m(9),    intervalMin: 30, type: '直通特急', destination: '新宿', toward: 'JR直通' },
        { fromMin: m(9),    toMin: m(18),   intervalMin: 30, type: '直通特急', destination: '新宿', toward: 'JR直通' },
        { fromMin: m(18),   toMin: m(22),   intervalMin: 30, type: '直通特急', destination: '新宿', toward: 'JR直通' },
        { fromMin: m(22),   toMin: m(23,30),intervalMin: 60, type: '直通特急', destination: '新宿', toward: 'JR直通' },
      ],
    },
    {
      label: '海老名方面',
      stations: [
        { name: '新宿', offset: 0 }, { name: '渋谷', offset: 4 }, { name: '恵比寿', offset: 8 },
        { name: '大崎', offset: 11 }, { name: '西大井', offset: 15 }, { name: '武蔵小杉', offset: 20 },
        { name: '羽沢横浜国大', offset: 28 }, { name: '西谷', offset: 32 }, { name: '二俣川', offset: 36 },
        { name: '希望ヶ丘', offset: 39 }, { name: '三ツ境', offset: 42 }, { name: '瀬谷', offset: 45 },
        { name: '大和', offset: 48 }, { name: '相模大塚', offset: 51 }, { name: 'さがみ野', offset: 54 },
        { name: 'かしわ台', offset: 56 }, { name: '海老名', offset: 59 },
      ],
      patterns: [
        { fromMin: m(6),    toMin: m(9),    intervalMin: 30, type: '直通特急', destination: '海老名', toward: '相鉄直通' },
        { fromMin: m(9),    toMin: m(18),   intervalMin: 30, type: '直通特急', destination: '海老名', toward: '相鉄直通' },
        { fromMin: m(18),   toMin: m(22),   intervalMin: 30, type: '直通特急', destination: '海老名', toward: '相鉄直通' },
        { fromMin: m(22),   toMin: m(23,30),intervalMin: 60, type: '直通特急', destination: '海老名', toward: '相鉄直通' },
      ],
    },
  ],
};
...
// 湘南モノレール（大船〜湘南江の島）
const shonanMonorailData: LineTimetableData = {
  key: 'shonanMonorail',
  name: '湘南モノレール',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      ...
      patterns: [
        { fromMin: m(6),    toMin: m(8),    intervalMin: 15, type: '普通', destination: '湘南江の島' },
        { fromMin: m(8),    toMin: m(19),   intervalMin: 10, type: '普通', destination: '湘南江の島' },
        { fromMin: m(19),   toMin: m(22),   intervalMin: 12, type: '普通', destination: '湘南江の島' },
        { fromMin: m(22),   toMin: m(23,30),intervalMin: 20, type: '普通', destination: '湘南江の島' },
      ],
    },
    {
      label: '大船方面',
      ...
      patterns: [
        { fromMin: m(6),    toMin: m(8),    intervalMin: 15, type: '普通', destination: '大船' },
        { fromMin: m(8),    toMin: m(19),   intervalMin: 10, type: '普通', destination: '大船' },
        { fromMin: m(19),   toMin: m(22),   intervalMin: 12, type: '普通', destination: '大船' },
        { fromMin: m(22),   toMin: m(23,30),intervalMin: 20, type: '普通', destination: '大船' },
      ],
    },
  ],
};
...
// 東武日光線（東武動物公園〜東武日光）
const tobuNikkoData: LineTimetableData = {
  key: 'tobuNikkoLine',
  name: '東武日光線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      ...
      stations: [
        ...
        { name: '新鹿沼', offset: 70 }, { name: '北鹿沼', offset: 74 }, { name: '板荷', offset: 79 },
        { name: '下小代', offset: 83 }, { name: '明神', offset: 87 }, { name: '下今市', offset: 90 },
        { name: '上今市', offset: 94 }, { name: '東武日光', offset: 97 },
      ],
      patterns: [
        { fromMin: m(6),    toMin: m(9),    intervalMin: 30, type: '普通', destination: '東武日光' },
        { fromMin: m(9),    toMin: m(16),   intervalMin: 60, type: '普通', destination: '東武日光' },
        { fromMin: m(16),   toMin: m(19),   intervalMin: 30, type: '普通', destination: '東武日光' },
        { fromMin: m(19),   toMin: m(22),   intervalMin: 60, type: '普通', destination: '東武日光' },
        { fromMin: m(6),    toMin: m(14),   intervalMin: 60, type: '特急きぬ', destination: '東武日光', toward: '日光方面' },
      ],
    },
    {
      label: '東武動物公園方面',
      stations: [
        ...
        { name: '明神', offset: 10 }, { name: '下小代', offset: 14 }, { name: '板荷', offset: 18 },
      ...
      patterns: [
        { fromMin: m(5,30), toMin: m(9),    intervalMin: 30, type: '普通', destination: '東武動物公園' },
        { fromMin: m(9),    toMin: m(16),   intervalMin: 60, type: '普通', destination: '東武動物公園' },
        { fromMin: m(16),   toMin: m(19),   intervalMin: 30, type: '普通', destination: '東武動物公園' },
        { fromMin: m(19),   toMin: m(22),   intervalMin: 60, type: '普通', destination: '東武動物公園' },
      ],
    },
  ],
};
...
// 東武大師線（西新井〜大師前）
const tobuDaishiData: LineTimetableData = {
  key: 'tobuDaishiLine',
  name: '東武大師線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      label: '大師前方面',
      stations: [
        { name: '西新井', offset: 0 }, { name: '大師前', offset: 1 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(9),    intervalMin: 15, type: '普通', destination: '大師前' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 20, type: '普通', destination: '大師前' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 15, type: '普通', destination: '大師前' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 20, type: '普通', destination: '大師前' },
      ],
    },
    {
      label: '西新井方面',
      stations: [
        { name: '大師前', offset: 0 }, { name: '西新井', offset: 1 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(9),    intervalMin: 15, type: '普通', destination: '西新井' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 20, type: '普通', destination: '西新井' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 15, type: '普通', destination: '西新井' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 20, type: '普通', destination: '西新井' },
      ],
    },
  ],
};
...
// 東武亀戸線（曳舟〜亀戸）
const tobuKameidoData: LineTimetableData = {
  key: 'tobuKameidoLine',
  name: '東武亀戸線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      ...
      patterns: [
        { fromMin: m(5,30), toMin: m(9),    intervalMin: 15, type: '普通', destination: '亀戸' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 20, type: '普通', destination: '亀戸' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 15, type: '普通', destination: '亀戸' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 20, type: '普通', destination: '亀戸' },
      ],
    },
    {
      label: '曳舟方面',
      ...
      patterns: [
        { fromMin: m(5,30), toMin: m(9),    intervalMin: 15, type: '普通', destination: '曳舟' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 20, type: '普通', destination: '曳舟' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 15, type: '普通', destination: '曳舟' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 20, type: '普通', destination: '曳舟' },
      ],
    },
  ],
};
...
// 新京成電鉄（松戸〜京成津田沼）
const shinkeiseiData: LineTimetableData = {
  key: 'shinkeisei',
  name: '新京成電鉄',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      ...
      stations: [
        ...
        { name: '五香', offset: 12 }, { name: '元山', offset: 14 }, { name: 'くぬぎ山', offset: 16 },
        { name: '北初富', offset: 18 }, { name: '新鎌ヶ谷', offset: 21 }, { name: '初富', offset: 24 },
        { name: '鎌ヶ谷大仏', offset: 26 }, { name: '二和向台', offset: 28 }, { name: '三咲', offset: 30 },
        { name: '習志野', offset: 34 }, { name: '薬園台', offset: 36 }, { name: '前原', offset: 38 },
        { name: '新津田沼', offset: 40 }, { name: '京成津田沼', offset: 42 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 12, type: '普通', destination: '京成津田沼' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 8,  type: '普通', destination: '京成津田沼' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 10, type: '普通', destination: '京成津田沼' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 8,  type: '普通', destination: '京成津田沼' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 12, type: '普通', destination: '京成津田沼' },
      ],
    },
    {
      label: '松戸方面',
      stations: [
        { name: '京成津田沼', offset: 0 }, { name: '新津田沼', offset: 2 }, { name: '前原', offset: 4 },
        { name: '薬園台', offset: 6 }, { name: '習志野', offset: 8 }, { name: '三咲', offset: 12 },
        { name: '二和向台', offset: 14 }, { name: '鎌ヶ谷大仏', offset: 16 }, { name: '初富', offset: 18 },
        { name: '新鎌ヶ谷', offset: 21 }, { name: '北初富', offset: 24 }, { name: 'くぬぎ山', offset: 26 },
        { name: '元山', offset: 28 }, { name: '五香', offset: 30 }, { name: '常盤平', offset: 32 },
        { name: '八柱', offset: 34 }, { name: 'みのり台', offset: 36 }, { name: '松戸新田', offset: 38 },
        { name: '上本郷', offset: 40 }, { name: '松戸', offset: 42 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 12, type: '普通', destination: '松戸' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 8,  type: '普通', destination: '松戸' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 10, type: '普通', destination: '松戸' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 8,  type: '普通', destination: '松戸' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 12, type: '普通', destination: '松戸' },
      ],
    },
  ],
};
...
// 東葉高速鉄道（西船橋〜東葉勝田台）
const toyoRapidData: LineTimetableData = {
  key: 'toyoRapid',
  name: '東葉高速鉄道',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      label: '東葉勝田台方面',
      stations: [
        { name: '西船橋', offset: 0 }, { name: '飯山満', offset: 4 },
        { name: '北習志野', offset: 7 }, { name: '船橋日大前', offset: 10 }, { name: '八千代緑が丘', offset: 13 },
        { name: '八千代中央', offset: 16 }, { name: '村上', offset: 19 }, { name: '東葉勝田台', offset: 22 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 12, type: '普通', destination: '東葉勝田台' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 8,  type: '普通', destination: '東葉勝田台' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 10, type: '普通', destination: '東葉勝田台' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 8,  type: '普通', destination: '東葉勝田台' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 12, type: '普通', destination: '東葉勝田台' },
      ],
    },
    {
      label: '西船橋方面',
      stations: [
        { name: '東葉勝田台', offset: 0 }, { name: '村上', offset: 3 }, { name: '八千代中央', offset: 6 },
        { name: '八千代緑が丘', offset: 9 }, { name: '船橋日大前', offset: 12 }, { name: '北習志野', offset: 15 },
        { name: '飯山満', offset: 18 }, { name: '西船橋', offset: 22 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 12, type: '普通', destination: '西船橋' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 8,  type: '普通', destination: '西船橋' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 10, type: '普通', destination: '西船橋' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 8,  type: '普通', destination: '西船橋' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 12, type: '普通', destination: '西船橋' },
      ],
    },
  ],
};
...
// JR八高線（八王子〜箱根ヶ崎）
const jrHachikoLineData: LineTimetableData = {
  key: 'jrHachikoLine',
  name: 'JR八高線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      ...
      patterns: [
        { fromMin: m(5,30), toMin: m(9),    intervalMin: 30, type: '普通', destination: '箱根ヶ崎' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 40, type: '普通', destination: '箱根ヶ崎' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 30, type: '普通', destination: '箱根ヶ崎' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 40, type: '普通', destination: '箱根ヶ崎' },
      ],
    },
    {
      label: '八王子方面',
      ...
      patterns: [
        { fromMin: m(5,30), toMin: m(9),    intervalMin: 30, type: '普通', destination: '八王子' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 40, type: '普通', destination: '八王子' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 30, type: '普通', destination: '八王子' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 40, type: '普通', destination: '八王子' },
      ],
    },
  ],
};
...
// JR五日市線（拝島〜武蔵五日市）
const jrItsukaichiLineData: LineTimetableData = {
  ...
  directions: [
    {
      ...
      patterns: [
        { fromMin: m(5,30), toMin: m(9),    intervalMin: 20, type: '普通', destination: '武蔵五日市' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 30, type: '普通', destination: '武蔵五日市' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 20, type: '普通', destination: '武蔵五日市' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 30, type: '普通', destination: '武蔵五日市' },
      ],
    },
    {
      label: '拝島方面',
      ...
      patterns: [
        { fromMin: m(5,30), toMin: m(9),    intervalMin: 20, type: '普通', destination: '拝島' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 30, type: '普通', destination: '拝島' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 20, type: '普通', destination: '拝島' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 30, type: '普通', destination: '拝島' },
      ],
    },
  ],
};
...
// JR伊東線（熱海〜伊東）
const jrItoLineData: LineTimetableData = {
  key: 'jrItoLine',
  name: 'JR伊東線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      label: '伊東方面',
      stations: [
        { name: '熱海', offset: 0 }, { name: '来宮', offset: 4 }, { name: '伊豆多賀', offset: 7 },
        { name: '網代', offset: 10 }, { name: '宇佐美', offset: 14 }, { name: '伊東', offset: 19 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(9),    intervalMin: 20, type: '普通', destination: '伊東' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 30, type: '普通', destination: '伊東' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 20, type: '普通', destination: '伊東' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 30, type: '普通', destination: '伊東' },
      ],
    },
    {
      label: '熱海方面',
      stations: [
        { name: '伊東', offset: 0 }, { name: '宇佐美', offset: 5 }, { name: '網代', offset: 9 },
        { name: '伊豆多賀', offset: 12 }, { name: '来宮', offset: 15 }, { name: '熱海', offset: 19 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(9),    intervalMin: 20, type: '普通', destination: '熱海' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 30, type: '普通', destination: '熱海' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 20, type: '普通', destination: '熱海' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 30, type: '普通', destination: '熱海' },
      ],
    },
  ],
};
...
// 伊豆急行線（伊東〜伊豆急下田）
const izukyuLineData: LineTimetableData = {
  key: 'izukyuLine',
  name: '伊豆急行線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      label: '伊豆急下田方面',
      stations: [
        { name: '伊東', offset: 0 }, { name: '南伊東', offset: 3 }, { name: '川奈', offset: 6 },
        { name: '富戸', offset: 10 }, { name: '城ヶ崎海岸', offset: 14 }, { name: '伊豆高原', offset: 17 },
        { name: '伊豆大川', offset: 21 }, { name: '伊豆北川', offset: 24 }, { name: '伊豆熱川', offset: 27 },
        { name: '片瀬白田', offset: 30 }, { name: '伊豆稲取', offset: 33 }, { name: '今井浜海岸', offset: 37 },
        { name: '河津', offset: 40 }, { name: '稲梓', offset: 44 }, { name: '蓮台寺', offset: 48 },
        { name: '伊豆急下田', offset: 51 },
      ],
      patterns: [
        { fromMin: m(6),    toMin: m(9),    intervalMin: 30, type: '普通', destination: '伊豆急下田' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 60, type: '普通', destination: '伊豆急下田' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 30, type: '普通', destination: '伊豆急下田' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 60, type: '普通', destination: '伊豆急下田' },
      ],
    },
    {
      label: '伊東方面',
      stations: [
        { name: '伊豆急下田', offset: 0 }, { name: '蓮台寺', offset: 3 }, { name: '稲梓', offset: 6 },
        { name: '河津', offset: 10 }, { name: '今井浜海岸', offset: 14 }, { name: '伊豆稲取', offset: 17 },
        { name: '片瀬白田', offset: 21 }, { name: '伊豆熱川', offset: 24 }, { name: '伊豆北川', offset: 27 },
        { name: '伊豆大川', offset: 30 }, { name: '伊豆高原', offset: 34 }, { name: '城ヶ崎海岸', offset: 37 },
        { name: '富戸', offset: 41 }, { name: '川奈', offset: 45 }, { name: '南伊東', offset: 48 },
        { name: '伊東', offset: 51 },
      ],
      patterns: [
        { fromMin: m(6),    toMin: m(9),    intervalMin: 30, type: '普通', destination: '伊東' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 60, type: '普通', destination: '伊東' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 30, type: '普通', destination: '伊東' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 60, type: '普通', destination: '伊東' },
      ],
    },
  ],
};
...
// 箱根登山鉄道（小田原〜強羅）
const hakoneTozanData: LineTimetableData = {
  key: 'hakoneTozan',
  name: '箱根登山鉄道',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      label: '強羅方面',
      stations: [
        { name: '小田原', offset: 0 }, { name: '箱根板橋', offset: 5 }, { name: '風祭', offset: 8 },
        { name: '入生田', offset: 11 }, { name: '箱根湯本', offset: 14 }, { name: '塔ノ沢', offset: 21 },
        { name: '大平台', offset: 26 }, { name: '宮ノ下', offset: 31 }, { name: '小涌谷', offset: 35 },
        { name: '彫刻の森', offset: 39 }, { name: '強羅', offset: 42 },
      ],
      patterns: [
        { fromMin: m(7),    toMin: m(9),    intervalMin: 15, type: '普通', destination: '強羅' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 20, type: '普通', destination: '強羅' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 20, type: '普通', destination: '強羅' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 30, type: '普通', destination: '強羅' },
      ],
    },
    {
      label: '小田原方面',
      stations: [
        { name: '強羅', offset: 0 }, { name: '彫刻の森', offset: 3 }, { name: '小涌谷', offset: 7 },
        { name: '宮ノ下', offset: 11 }, { name: '大平台', offset: 16 }, { name: '塔ノ沢', offset: 21 },
        { name: '箱根湯本', offset: 28 }, { name: '入生田', offset: 31 }, { name: '風祭', offset: 34 },
        { name: '箱根板橋', offset: 37 }, { name: '小田原', offset: 42 },
      ],
      patterns: [
        { fromMin: m(7),    toMin: m(9),    intervalMin: 15, type: '普通', destination: '小田原' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 20, type: '普通', destination: '小田原' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 20, type: '普通', destination: '小田原' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 30, type: '普通', destination: '小田原' },
      ],
    },
  ],
};
...
// 伊豆箱根鉄道駿豆線（三島〜修善寺）
const izuHakoneSunzuData: LineTimetableData = {
  key: 'izuHakoneSunzu',
  name: '伊豆箱根鉄道駿豆線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      label: '修善寺方面',
      stations: [
        { name: '三島', offset: 0 }, { name: '三島広小路', offset: 2 }, { name: '三島田町', offset: 4 },
        { name: '三島二日町', offset: 7 }, { name: '大場', offset: 10 }, { name: '伊豆仁田', offset: 13 },
        { name: '原木', offset: 15 }, { name: '韮山', offset: 18 }, { name: '伊豆長岡', offset: 20 },
        { name: '田京', offset: 23 }, { name: '大仁', offset: 26 }, { name: '牧之郷', offset: 30 },
        { name: '修善寺', offset: 33 },
      ],
      patterns: [
        { fromMin: m(6),    toMin: m(9),    intervalMin: 20, type: '普通', destination: '修善寺' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 30, type: '普通', destination: '修善寺' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 20, type: '普通', destination: '修善寺' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 30, type: '普通', destination: '修善寺' },
      ],
    },
    {
      label: '三島方面',
      stations: [
        { name: '修善寺', offset: 0 }, { name: '牧之郷', offset: 3 }, { name: '大仁', offset: 7 },
        { name: '田京', offset: 10 }, { name: '伊豆長岡', offset: 13 }, { name: '韮山', offset: 15 },
        { name: '原木', offset: 18 }, { name: '伊豆仁田', offset: 20 }, { name: '大場', offset: 23 },
        { name: '三島二日町', offset: 26 }, { name: '三島田町', offset: 29 }, { name: '三島広小路', offset: 31 },
        { name: '三島', offset: 33 },
      ],
      patterns: [
        { fromMin: m(6),    toMin: m(9),    intervalMin: 20, type: '普通', destination: '三島' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 30, type: '普通', destination: '三島' },
        { fromMin: m(17),   toMin: m(21),   intervalMin: 20, type: '普通', destination: '三島' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 30, type: '普通', destination: '三島' },
      ],
    },
  ],
};
...
// JR内房線（蘇我〜館山）
const jrUchiboLineData: LineTimetableData = {
  key: 'jrUchiboLine',
  name: 'JR内房線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      label: '館山方面',
      stations: [
        { name: '蘇我', offset: 0 }, { name: '浜野', offset: 5 }, { name: '八幡宿', offset: 9 },
        { name: '五井', offset: 13 }, { name: '姉ケ崎', offset: 17 }, { name: '長浦', offset: 21 },
        { name: '袖ケ浦', offset: 25 }, { name: '巌根', offset: 29 }, { name: '木更津', offset: 33 },
        { name: '君津', offset: 41 }, { name: '青堀', offset: 47 }, { name: '大貫', offset: 51 },
        { name: '佐貫町', offset: 55 }, { name: '上総湊', offset: 59 }, { name: '竹岡', offset: 64 },
        { name: '浜金谷', offset: 69 }, { name: '保田', offset: 74 }, { name: '安房勝山', offset: 79 },
        { name: '岩井', offset: 84 }, { name: '富浦', offset: 89 }, { name: '館山', offset: 94 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 20, type: '普通', destination: '館山' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 30, type: '快速', destination: '館山' },
        { fromMin: m(9),    toMin: m(16),   intervalMin: 60, type: '普通', destination: '館山' },
        { fromMin: m(16),   toMin: m(20),   intervalMin: 30, type: '普通', destination: '館山' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 60, type: '普通', destination: '館山' },
      ],
    },
    {
      label: '蘇我・千葉方面',
      stations: [
        { name: '館山', offset: 0 }, { name: '富浦', offset: 5 }, { name: '岩井', offset: 10 },
        { name: '安房勝山', offset: 15 }, { name: '保田', offset: 20 }, { name: '浜金谷', offset: 25 },
        { name: '竹岡', offset: 30 }, { name: '上総湊', offset: 35 }, { name: '佐貫町', offset: 39 },
        { name: '大貫', offset: 43 }, { name: '青堀', offset: 47 }, { name: '君津', offset: 53 },
        { name: '木更津', offset: 61 }, { name: '巌根', offset: 65 }, { name: '袖ケ浦', offset: 69 },
        { name: '長浦', offset: 73 }, { name: '姉ケ崎', offset: 77 }, { name: '五井', offset: 81 },
        { name: '八幡宿', offset: 85 }, { name: '浜野', offset: 89 }, { name: '蘇我', offset: 94 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 20, type: '普通', destination: '蘇我' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 30, type: '快速', destination: '千葉' },
        { fromMin: m(9),    toMin: m(16),   intervalMin: 60, type: '普通', destination: '蘇我' },
        { fromMin: m(16),   toMin: m(20),   intervalMin: 30, type: '普通', destination: '千葉' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 60, type: '普通', destination: '蘇我' },
      ],
    },
  ],
};
...
// JR外房線（千葉〜大原）
const jrSotoboLineData: LineTimetableData = {
  key: 'jrSotoboLine',
  name: 'JR外房線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      label: '大原方面',
      stations: [
        { name: '千葉', offset: 0 }, { name: '本千葉', offset: 3 }, { name: '蘇我', offset: 7 },
        { name: '鎌取', offset: 13 }, { name: '誉田', offset: 18 }, { name: '土気', offset: 23 },
        { name: '大網', offset: 29 }, { name: '永田', offset: 33 }, { name: '本納', offset: 37 },
        { name: '新茂原', offset: 41 }, { name: '茂原', offset: 45 }, { name: '八積', offset: 50 },
        { name: '上総一ノ宮', offset: 55 }, { name: '東浪見', offset: 59 }, { name: '太東', offset: 63 },
        { name: '長者町', offset: 67 }, { name: '三門', offset: 71 }, { name: '大原', offset: 75 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 20, type: '普通', destination: '大原' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 15, type: '快速', destination: '大原' },
        { fromMin: m(9),    toMin: m(16),   intervalMin: 30, type: '普通', destination: '大原' },
        { fromMin: m(16),   toMin: m(20),   intervalMin: 20, type: '普通', destination: '大原' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 30, type: '普通', destination: '大原' },
      ],
    },
    {
      label: '千葉方面',
      stations: [
        { name: '大原', offset: 0 }, { name: '三門', offset: 4 }, { name: '長者町', offset: 8 },
        { name: '太東', offset: 12 }, { name: '東浪見', offset: 16 }, { name: '上総一ノ宮', offset: 20 },
        { name: '八積', offset: 25 }, { name: '茂原', offset: 30 }, { name: '新茂原', offset: 34 },
        { name: '本納', offset: 38 }, { name: '永田', offset: 42 }, { name: '大網', offset: 46 },
        { name: '土気', offset: 52 }, { name: '誉田', offset: 57 }, { name: '鎌取', offset: 62 },
        { name: '蘇我', offset: 68 }, { name: '本千葉', offset: 72 }, { name: '千葉', offset: 75 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 20, type: '普通', destination: '千葉' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 15, type: '快速', destination: '千葉' },
        { fromMin: m(9),    toMin: m(16),   intervalMin: 30, type: '普通', destination: '千葉' },
        { fromMin: m(16),   toMin: m(20),   intervalMin: 20, type: '普通', destination: '千葉' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 30, type: '普通', destination: '千葉' },
      ],
    },
  ],
};
...
// JR成田線（千葉〜銚子）
const jrNaritaLineData: LineTimetableData = {
  key: 'jrNaritaLine',
  name: 'JR成田線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      label: '銚子方面',
      stations: [
        { name: '千葉', offset: 0 }, { name: '東千葉', offset: 3 }, { name: '都賀', offset: 7 },
        { name: '四街道', offset: 13 }, { name: '物井', offset: 18 }, { name: '佐倉', offset: 24 },
        { name: '酒々井', offset: 28 }, { name: '成田', offset: 33 }, { name: '久住', offset: 38 },
        { name: '滑河', offset: 43 }, { name: '下総神崎', offset: 48 }, { name: '大戸', offset: 53 },
        { name: '佐原', offset: 58 }, { name: '香取', offset: 63 }, { name: '水郷', offset: 68 },
        { name: '小見川', offset: 73 }, { name: '笹川', offset: 78 }, { name: '下総橘', offset: 82 },
        { name: '下総豊里', offset: 86 }, { name: '椎柴', offset: 90 }, { name: '銚子', offset: 94 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 30, type: '普通', destination: '銚子' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 20, type: '普通', destination: '銚子' },
        { fromMin: m(9),    toMin: m(16),   intervalMin: 60, type: '普通', destination: '銚子' },
        { fromMin: m(16),   toMin: m(20),   intervalMin: 30, type: '普通', destination: '銚子' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 60, type: '普通', destination: '銚子' },
      ],
    },
    {
      label: '千葉方面',
      stations: [
        { name: '銚子', offset: 0 }, { name: '椎柴', offset: 4 }, { name: '下総豊里', offset: 8 },
        { name: '下総橘', offset: 12 }, { name: '笹川', offset: 16 }, { name: '小見川', offset: 21 },
        { name: '水郷', offset: 26 }, { name: '香取', offset: 31 }, { name: '佐原', offset: 36 },
        { name: '大戸', offset: 41 }, { name: '下総神崎', offset: 46 }, { name: '滑河', offset: 51 },
        { name: '久住', offset: 56 }, { name: '成田', offset: 61 }, { name: '酒々井', offset: 66 },
        { name: '佐倉', offset: 70 }, { name: '物井', offset: 76 }, { name: '四街道', offset: 81 },
        { name: '都賀', offset: 87 }, { name: '東千葉', offset: 91 }, { name: '千葉', offset: 94 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 30, type: '普通', destination: '千葉' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 20, type: '普通', destination: '千葉' },
        { fromMin: m(9),    toMin: m(16),   intervalMin: 60, type: '普通', destination: '千葉' },
        { fromMin: m(16),   toMin: m(20),   intervalMin: 30, type: '普通', destination: '千葉' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 60, type: '普通', destination: '千葉' },
      ],
    },
  ],
};
...
// JR神戸線（大阪〜住吉）
const jrKobeLineData: LineTimetableData = {
  key: 'jrKobeLine',
  name: 'JR神戸線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      label: '神戸・姫路方面',
      stations: [
        { name: '大阪', offset: 0 }, { name: '塚本', offset: 2 }, { name: '尼崎', offset: 4 },
        { name: '立花', offset: 6 }, { name: '甲子園口', offset: 8 }, { name: '西宮', offset: 10 },
        { name: 'さくら夙川', offset: 12 }, { name: '芦屋', offset: 14 }, { name: '甲南山手', offset: 16 },
        { name: '摂津本山', offset: 18 }, { name: '住吉', offset: 20 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 10, type: '普通', destination: '住吉' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 5,  type: '新快速', destination: '姫路' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 10, type: '普通', destination: '住吉' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 7,  type: '新快速', destination: '姫路' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 10, type: '普通', destination: '住吉' },
      ],
    },
    {
      label: '大阪方面',
      stations: [
        { name: '住吉', offset: 0 }, { name: '摂津本山', offset: 2 }, { name: '甲南山手', offset: 4 },
        { name: '芦屋', offset: 6 }, { name: 'さくら夙川', offset: 8 }, { name: '西宮', offset: 10 },
        { name: '甲子園口', offset: 12 }, { name: '立花', offset: 14 }, { name: '尼崎', offset: 16 },
        { name: '塚本', offset: 18 }, { name: '大阪', offset: 20 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 10, type: '普通', destination: '大阪' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 5,  type: '新快速', destination: '大阪' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 10, type: '普通', destination: '大阪' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 7,  type: '新快速', destination: '大阪' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 10, type: '普通', destination: '大阪' },
      ],
    },
  ],
};
...
// JR京都線（京都〜大阪）
const jrKyotoLineData: LineTimetableData = {
  key: 'jrKyotoLine',
  name: 'JR京都線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      label: '大阪・神戸方面',
      stations: [
        { name: '京都', offset: 0 }, { name: '西大路', offset: 2 }, { name: '桂川', offset: 4 },
        { name: '向日町', offset: 6 }, { name: '長岡京', offset: 8 }, { name: '山崎', offset: 10 },
        { name: '島本', offset: 12 }, { name: '高槻', offset: 14 }, { name: '摂津富田', offset: 16 },
        { name: 'JR総持寺', offset: 18 }, { name: '茨木', offset: 20 }, { name: '千里丘', offset: 22 },
        { name: '岸辺', offset: 24 }, { name: '吹田', offset: 26 }, { name: '東淀川', offset: 28 },
        { name: '新大阪', offset: 30 }, { name: '大阪', offset: 32 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 10, type: '普通', destination: '大阪' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 5,  type: '新快速', destination: '大阪' },
    ...
    },
    {
      label: '京都方面',
      stations: [
        { name: '大阪', offset: 0 }, { name: '新大阪', offset: 2 }, { name: '東淀川', offset: 4 },
        { name: '吹田', offset: 6 }, { name: '岸辺', offset: 8 }, { name: '千里丘', offset: 10 },
        { name: '茨木', offset: 12 }, { name: 'JR総持寺', offset: 14 }, { name: '摂津富田', offset: 16 },
        { name: '高槻', offset: 18 }, { name: '島本', offset: 20 }, { name: '山崎', offset: 22 },
        { name: '長岡京', offset: 24 }, { name: '向日町', offset: 26 }, { name: '桂川', offset: 28 },
        { name: '西大路', offset: 30 }, { name: '京都', offset: 32 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 10, type: '普通', destination: '京都' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 5,  type: '新快速', destination: '京都' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 10, type: '普通', destination: '京都' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 7,  type: '新快速', destination: '京都' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 10, type: '普通', destination: '京都' },
      ],
    },
  ],
};
...
// 大阪環状線（内回り・外回り）
const osakaLoopLineData: LineTimetableData = {
  key: 'osakaLoopLine',
  name: '大阪環状線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      label: '内回り（天王寺→大阪方面）',
      stations: [
        { name: '天王寺', offset: 0 }, { name: '寺田町', offset: 2 }, { name: '桃谷', offset: 4 },
        { name: '鶴橋', offset: 6 }, { name: '玉造', offset: 8 }, { name: '森ノ宮', offset: 10 },
        { name: '大阪城公園', offset: 12 }, { name: '京橋', offset: 14 }, { name: '桜ノ宮', offset: 16 },
        { name: '天満', offset: 18 }, { name: '大阪', offset: 20 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 6,  type: '普通', destination: '大阪' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 4,  type: '普通', destination: '大阪' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 6,  type: '普通', destination: '大阪' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 4,  type: '普通', destination: '大阪' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 6,  type: '普通', destination: '大阪' },
      ],
    },
    {
      label: '外回り（大阪→天王寺方面）',
      stations: [
        { name: '大阪', offset: 0 }, { name: '福島', offset: 2 }, { name: '野田', offset: 4 },
        { name: '西九条', offset: 6 }, { name: '弁天町', offset: 8 }, { name: '大正', offset: 10 },
        { name: '芦原橋', offset: 12 }, { name: '今宮', offset: 14 }, { name: '新今宮', offset: 16 },
        { name: '天王寺', offset: 18 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 6,  type: '普通', destination: '天王寺' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 4,  type: '普通', destination: '天王寺' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 6,  type: '普通', destination: '天王寺' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 4,  type: '普通', destination: '天王寺' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 6,  type: '普通', destination: '天王寺' },
      ],
    },
  ],
};
...
// 大阪メトロ御堂筋線（江坂〜なかもず）
const midosujiLineData: LineTimetableData = {
  key: 'midosujiLine',
  name: '大阪メトロ御堂筋線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算）',
  directions: [
    {
      label: 'なかもず方面',
      stations: [
        { name: '江坂', offset: 0 }, { name: '東三国', offset: 2 }, { name: '新大阪', offset: 4 },
        { name: '西中島南方', offset: 6 }, { name: '中津', offset: 8 }, { name: '梅田', offset: 10 },
        { name: '淀屋橋', offset: 12 }, { name: '本町', offset: 14 }, { name: '心斎橋', offset: 16 },
        { name: 'なんば', offset: 18 }, { name: '大国町', offset: 20 }, { name: '動物園前', offset: 22 },
        { name: '天王寺', offset: 24 }, { name: '昭和町', offset: 26 }, { name: '西田辺', offset: 28 },
        { name: '長居', offset: 30 }, { name: 'あびこ', offset: 32 }, { name: '北花田', offset: 34 },
        { name: '新金岡', offset: 36 }, { name: 'なかもず', offset: 38 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 5,  type: '普通', destination: 'なかもず' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 3,  type: '普通', destination: 'なかもず' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 4,  type: '普通', destination: 'なかもず' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 3,  type: '普通', destination: 'なかもず' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 5,  type: '普通', destination: 'なかもず' },
      ],
    },
    {
      label: '江坂方面',
      stations: [
        { name: 'なかもず', offset: 0 }, { name: '新金岡', offset: 2 }, { name: '北花田', offset: 4 },
        { name: 'あびこ', offset: 6 }, { name: '長居', offset: 8 }, { name: '西田辺', offset: 10 },
        { name: '昭和町', offset: 12 }, { name: '天王寺', offset: 14 }, { name: '動物園前', offset: 16 },
        { name: '大国町', offset: 18 }, { name: 'なんば', offset: 20 }, { name: '心斎橋', offset: 22 },
        { name: '本町', offset: 24 }, { name: '淀屋橋', offset: 26 }, { name: '梅田', offset: 28 },
        { name: '中津', offset: 30 }, { name: '西中島南方', offset: 32 }, { name: '新大阪', offset: 34 },
        { name: '東三国', offset: 36 }, { name: '江坂', offset: 38 },
      ],
      patterns: [
        { fromMin: m(5,30), toMin: m(7),    intervalMin: 5,  type: '普通', destination: '江坂' },
        { fromMin: m(7),    toMin: m(9),    intervalMin: 3,  type: '普通', destination: '江坂' },
        { fromMin: m(9),    toMin: m(17),   intervalMin: 4,  type: '普通', destination: '江坂' },
        { fromMin: m(17),   toMin: m(20),   intervalMin: 3,  type: '普通', destination: '江坂' },
        { fromMin: m(20),   toMin: m(23),   intervalMin: 5,  type: '普通', destination: '江坂' },
      ],
    },
  ],
};
...
// 東海道新幹線（東京〜新大阪）
const tokaidoShinkansenData: LineTimetableData = {
  key: 'tokaidoShinkansen',
  name: '東海道新幹線',
  updatedAt: '2025-03-15',
  dataVersion: '2025年版（概算・こだま）',
  directions: [
    {
      label: '新大阪方面',
      stations: [
        { name: '東京', offset: 0 }, { name: '品川', offset: 3 }, { name: '新横浜', offset: 11 },
        { name: '小田原', offset: 26 }, { name: '熱海', offset: 36 }, { name: '三島', offset: 44 },
        { name: '新富士', offset: 54 }, { name: '静岡', offset: 66 }, { name: '掛川', offset: 78 },
        { name: '浜松', offset: 93 }, { name: '豊橋', offset: 103 }, { name: '三河安城', offset: 113 },
        { name: '名古屋', offset: 123 }, { name: '岐阜羽島', offset: 133 }, { name: '米原', offset: 153 },
        { name: '京都', offset: 168 }, { name: '新大阪', offset: 183 },
      ],
      patterns: [
        { fromMin: m(6),    toMin: m(9),    intervalMin: 20, type: 'のぞみ', destination: '新大阪', toward: '新大阪方面' },
        { fromMin: m(9),    toMin: m(18),   intervalMin: 15, type: 'のぞみ', destination: '新大阪', toward: '新大阪方面' },
        { fromMin: m(18),   toMin: m(21),   intervalMin: 20, type: 'のぞみ', destination: '新大阪', toward: '新大阪方面' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 30, type: 'のぞみ', destination: '新大阪', toward: '新大阪方面' },
      ],
    },
    {
      label: '東京方面',
      stations: [
        { name: '新大阪', offset: 0 }, { name: '京都', offset: 15 }, { name: '米原', offset: 30 },
        { name: '岐阜羽島', offset: 50 }, { name: '名古屋', offset: 60 }, { name: '三河安城', offset: 70 },
        { name: '豊橋', offset: 80 }, { name: '浜松', offset: 90 }, { name: '掛川', offset: 105 },
        { name: '静岡', offset: 117 }, { name: '新富士', offset: 129 }, { name: '三島', offset: 139 },
        { name: '熱海', offset: 147 }, { name: '小田原', offset: 157 }, { name: '新横浜', offset: 172 },
        { name: '品川', offset: 180 }, { name: '東京', offset: 183 },
      ],
      patterns: [
        { fromMin: m(6),    toMin: m(9),    intervalMin: 20, type: 'のぞみ', destination: '東京', toward: '東京方面' },
        { fromMin: m(9),    toMin: m(18),   intervalMin: 15, type: 'のぞみ', destination: '東京', toward: '東京方面' },
        { fromMin: m(18),   toMin: m(21),   intervalMin: 20, type: 'のぞみ', destination: '東京', toward: '東京方面' },
        { fromMin: m(21),   toMin: m(23),   intervalMin: 30, type: 'のぞみ', destination: '東京', toward: '東京方面' },
      ],
    },
  ],
};

// ── 首都圏の未対応路線を補完（2026-08 追加）────────────────
// 対象は1都3県で時刻表が無かった路線のうち、乗換で使われる主要なもの。
// 他の路線と同じく、各社公表の運行間隔から組み立てた概算値。
// 行き先は実在しない列車名を出さないよう「〜方面」で統一する。
  ...
  directions: [
    {
      label: '大宮→逗子',
      stations: [
        { name: '大宮', offset: 0 }, { name: '浦和', offset: 5 }, { name: '赤羽', offset: 13 },
        { name: '池袋', offset: 21 }, { name: '新宿', offset: 26 }, { name: '渋谷', offset: 30 },
        { name: '恵比寿', offset: 32 }, { name: '大崎', offset: 35 }, { name: '西大井', offset: 39 },
        { name: '武蔵小杉', offset: 44 }, { name: '新川崎', offset: 47 }, { name: '横浜', offset: 57 },
        { name: '保土ケ谷', offset: 60 }, { name: '東戸塚', offset: 63 }, { name: '戸塚', offset: 68 },
        { name: '大船', offset: 74 }, { name: '北鎌倉', offset: 79 }, { name: '鎌倉', offset: 83 },
        { name: '逗子', offset: 87 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 30, type: '普通', destination: '横浜方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 15, type: '快速', destination: '横浜方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 15, type: '快速', destination: '横浜方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 12, type: '快速', destination: '横浜方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 20, type: '普通', destination: '横浜方面' },
      ],
    },
    {
      label: '逗子→大宮',
      stations: [
        { name: '逗子', offset: 0 }, { name: '鎌倉', offset: 4 }, { name: '北鎌倉', offset: 8 },
        { name: '大船', offset: 13 }, { name: '戸塚', offset: 19 }, { name: '東戸塚', offset: 24 },
        { name: '保土ケ谷', offset: 27 }, { name: '横浜', offset: 30 }, { name: '新川崎', offset: 40 },
        { name: '武蔵小杉', offset: 43 }, { name: '西大井', offset: 48 }, { name: '大崎', offset: 52 },
        { name: '恵比寿', offset: 55 }, { name: '渋谷', offset: 57 }, { name: '新宿', offset: 61 },
        { name: '池袋', offset: 66 }, { name: '赤羽', offset: 74 }, { name: '浦和', offset: 82 },
        { name: '大宮', offset: 87 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 30, type: '普通', destination: '大宮方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 12, type: '快速', destination: '大宮方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 15, type: '快速', destination: '大宮方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 15, type: '快速', destination: '大宮方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 20, type: '普通', destination: '大宮方面' },
      ],
    },
  ],
};

const minatomiraiData: LineTimetableData = {
  key: 'minatomirai', name: 'みなとみらい線', ...KANTO_ADD,
  directions: [
    {
      label: '横浜→元町・中華街',
      stations: [
        { name: '横浜', offset: 0 }, { name: '新高島', offset: 3 }, { name: 'みなとみらい', offset: 6 },
        { name: '馬車道', offset: 9 }, { name: '日本大通り', offset: 12 }, { name: '元町・中華街', offset: 15 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 8, type: '各停', destination: '元町・中華街方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 4, type: '各停', destination: '元町・中華街方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 5, type: '各停', destination: '元町・中華街方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 4, type: '各停', destination: '元町・中華街方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 7, type: '各停', destination: '元町・中華街方面' },
      ],
    },
    {
      label: '元町・中華街→横浜',
      stations: [
        { name: '元町・中華街', offset: 0 }, { name: '日本大通り', offset: 3 }, { name: '馬車道', offset: 6 },
        { name: 'みなとみらい', offset: 9 }, { name: '新高島', offset: 12 }, { name: '横浜', offset: 15 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 8, type: '各停', destination: '横浜方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 4, type: '各停', destination: '横浜方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 5, type: '各停', destination: '横浜方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 4, type: '各停', destination: '横浜方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 7, type: '各停', destination: '横浜方面' },
      ],
    },
  ],
};

const tobuNodaData: LineTimetableData = {
  key: 'tobuNodaLine', name: '東武アーバンパークライン', ...KANTO_ADD,
  source: '各社公表の運行間隔をもとにした概算。柏で系統が分かれるため行き先は方面表記とした',
  directions: [
    {
      label: '大宮→船橋',
      stations: [
        { name: '大宮', offset: 0 }, { name: '北大宮', offset: 3 }, { name: '大宮公園', offset: 6 },
        { name: '大和田', offset: 9 }, { name: '七里', offset: 12 }, { name: '岩槻', offset: 15 },
        { name: '東岩槻', offset: 20 }, { name: '豊春', offset: 24 }, { name: '八木崎', offset: 27 },
        { name: '春日部', offset: 30 }, { name: '藤の牛島', offset: 33 }, { name: '南桜井', offset: 37 },
        { name: '川間', offset: 41 }, { name: '七光台', offset: 44 }, { name: '清水公園', offset: 47 },
        { name: '愛宕', offset: 50 }, { name: '野田市', offset: 52 }, { name: '梅郷', offset: 55 },
        { name: '運河', offset: 59 }, { name: '江戸川台', offset: 63 }, { name: '初石', offset: 66 },
        { name: '流山おおたかの森', offset: 69 }, { name: '柏の葉キャンパス', offset: 73 }, { name: '柏', offset: 77 },
        { name: '新柏', offset: 80 }, { name: '増尾', offset: 83 }, { name: '逆井', offset: 86 },
        { name: '高柳', offset: 89 }, { name: '六実', offset: 93 }, { name: '新鎌ヶ谷', offset: 97 },
        { name: '鎌ヶ谷', offset: 101 }, { name: '馬込沢', offset: 105 }, { name: '塚田', offset: 108 },
        { name: '船橋', offset: 111 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 15, type: '各停', destination: '船橋方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 8,  type: '各停', destination: '船橋方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 10, type: '各停', destination: '船橋方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 8,  type: '各停', destination: '船橋方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 12, type: '各停', destination: '船橋方面' },
      ],
    },
    {
      label: '船橋→大宮',
      stations: [
        { name: '船橋', offset: 0 }, { name: '塚田', offset: 3 }, { name: '馬込沢', offset: 6 },
        { name: '鎌ヶ谷', offset: 10 }, { name: '新鎌ヶ谷', offset: 14 }, { name: '六実', offset: 18 },
        { name: '高柳', offset: 22 }, { name: '逆井', offset: 25 }, { name: '増尾', offset: 28 },
        { name: '新柏', offset: 31 }, { name: '柏', offset: 34 }, { name: '柏の葉キャンパス', offset: 38 },
        { name: '流山おおたかの森', offset: 42 }, { name: '初石', offset: 45 }, { name: '江戸川台', offset: 48 },
        { name: '運河', offset: 52 }, { name: '梅郷', offset: 56 }, { name: '野田市', offset: 59 },
        { name: '愛宕', offset: 61 }, { name: '清水公園', offset: 64 }, { name: '七光台', offset: 67 },
        { name: '川間', offset: 70 }, { name: '南桜井', offset: 74 }, { name: '藤の牛島', offset: 78 },
        { name: '春日部', offset: 81 }, { name: '八木崎', offset: 84 }, { name: '豊春', offset: 87 },
        { name: '東岩槻', offset: 91 }, { name: '岩槻', offset: 96 }, { name: '七里', offset: 99 },
        { name: '大和田', offset: 102 }, { name: '大宮公園', offset: 105 }, { name: '北大宮', offset: 108 },
        { name: '大宮', offset: 111 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 15, type: '各停', destination: '大宮方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 8,  type: '各停', destination: '大宮方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 10, type: '各停', destination: '大宮方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 8,  type: '各停', destination: '大宮方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 12, type: '各停', destination: '大宮方面' },
      ],
    },
  ],
};

const jrSagamiData: LineTimetableData = {
  key: 'jrSagamiLine', name: 'JR相模線', ...KANTO_ADD,
  directions: [
    {
      label: '茅ヶ崎→橋本',
      stations: [
        { name: '茅ヶ崎', offset: 0 }, { name: '北茅ヶ崎', offset: 4 }, { name: '香川', offset: 7 },
        { name: '寒川', offset: 10 }, { name: '宮山', offset: 13 }, { name: '倉見', offset: 17 },
        { name: '門沢橋', offset: 21 }, { name: '社家', offset: 26 }, { name: '厚木', offset: 30 },
        { name: '海老名', offset: 35 }, { name: '入谷', offset: 40 }, { name: '相武台下', offset: 44 },
        { name: '下溝', offset: 48 }, { name: '原当麻', offset: 51 }, { name: '番田', offset: 55 },
        { name: '上溝', offset: 59 }, { name: '南橋本', offset: 63 }, { name: '橋本', offset: 67 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 30, type: '各停', destination: '橋本方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 12, type: '各停', destination: '橋本方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 20, type: '各停', destination: '橋本方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 15, type: '各停', destination: '橋本方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 20, type: '各停', destination: '橋本方面' },
      ],
    },
    {
      label: '橋本→茅ヶ崎',
      stations: [
        { name: '橋本', offset: 0 }, { name: '南橋本', offset: 4 }, { name: '上溝', offset: 8 },
        { name: '番田', offset: 12 }, { name: '原当麻', offset: 16 }, { name: '下溝', offset: 19 },
        { name: '相武台下', offset: 23 }, { name: '入谷', offset: 27 }, { name: '海老名', offset: 32 },
        { name: '厚木', offset: 37 }, { name: '社家', offset: 41 }, { name: '門沢橋', offset: 46 },
        { name: '倉見', offset: 50 }, { name: '宮山', offset: 54 }, { name: '寒川', offset: 57 },
        { name: '香川', offset: 60 }, { name: '北茅ヶ崎', offset: 63 }, { name: '茅ヶ崎', offset: 67 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 30, type: '各停', destination: '茅ヶ崎方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 12, type: '各停', destination: '茅ヶ崎方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 20, type: '各停', destination: '茅ヶ崎方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 15, type: '各停', destination: '茅ヶ崎方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 20, type: '各停', destination: '茅ヶ崎方面' },
      ],
    },
  ],
};

const jrTsurumiData: LineTimetableData = {
  key: 'jrTsurumiLine', name: 'JR鶴見線', ...KANTO_ADD,
  directions: [
    {
      label: '鶴見→扇町',
      stations: [
        { name: '鶴見', offset: 0 }, { name: '国道', offset: 2 }, { name: '鶴見小野', offset: 4 },
        { name: '弁天橋', offset: 6 }, { name: '浜川崎', offset: 8 }, { name: '昭和', offset: 11 },
        { name: '扇町', offset: 14 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 20, type: '各停', destination: '扇町方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 10, type: '各停', destination: '扇町方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 20, type: '各停', destination: '扇町方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 12, type: '各停', destination: '扇町方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 25, type: '各停', destination: '扇町方面' },
      ],
    },
    {
      label: '扇町→鶴見',
      stations: [
        { name: '扇町', offset: 0 }, { name: '昭和', offset: 3 }, { name: '浜川崎', offset: 6 },
        { name: '弁天橋', offset: 8 }, { name: '鶴見小野', offset: 10 }, { name: '国道', offset: 12 },
        { name: '鶴見', offset: 14 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 20, type: '各停', destination: '鶴見方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 10, type: '各停', destination: '鶴見方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 20, type: '各停', destination: '鶴見方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 12, type: '各停', destination: '鶴見方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 25, type: '各停', destination: '鶴見方面' },
      ],
    },
  ],
};

const seibuTamagawaData: LineTimetableData = {
  key: 'seibuTamagawaLine', name: '西武多摩川線', ...KANTO_ADD,
  directions: [
    {
      label: '武蔵境→是政',
      stations: [
        { name: '武蔵境', offset: 0 }, { name: '新小金井', offset: 4 }, { name: '多磨', offset: 7 },
        { name: '白糸台', offset: 10 }, { name: '競艇場前', offset: 13 }, { name: '是政', offset: 15 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 15, type: '各停', destination: '是政方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 8,  type: '各停', destination: '是政方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 12, type: '各停', destination: '是政方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 10, type: '各停', destination: '是政方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 15, type: '各停', destination: '是政方面' },
      ],
    },
    {
      label: '是政→武蔵境',
      stations: [
        { name: '是政', offset: 0 }, { name: '競艇場前', offset: 2 }, { name: '白糸台', offset: 5 },
        { name: '多磨', offset: 8 }, { name: '新小金井', offset: 11 }, { name: '武蔵境', offset: 15 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 15, type: '各停', destination: '武蔵境方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 8,  type: '各停', destination: '武蔵境方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 12, type: '各停', destination: '武蔵境方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 10, type: '各停', destination: '武蔵境方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 15, type: '各停', destination: '武蔵境方面' },
      ],
    },
  ],
};

const keikyuZushiData: LineTimetableData = {
  key: 'keikyuZushiLine', name: '京急逗子線', ...KANTO_ADD,
  directions: [
    {
      label: '金沢八景→逗子・葉山',
      stations: [
        { name: '金沢八景', offset: 0 }, { name: '六浦', offset: 4 }, { name: '神武寺', offset: 8 },
        { name: '逗子・葉山', offset: 12 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 15, type: '各停', destination: '逗子・葉山方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 8,  type: '各停', destination: '逗子・葉山方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 10, type: '各停', destination: '逗子・葉山方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 8,  type: '各停', destination: '逗子・葉山方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 12, type: '各停', destination: '逗子・葉山方面' },
      ],
    },
    {
      label: '逗子・葉山→金沢八景',
      stations: [
        { name: '逗子・葉山', offset: 0 }, { name: '神武寺', offset: 4 }, { name: '六浦', offset: 8 },
        { name: '金沢八景', offset: 12 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 15, type: '各停', destination: '金沢八景方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 8,  type: '各停', destination: '金沢八景方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 10, type: '各停', destination: '金沢八景方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 8,  type: '各停', destination: '金沢八景方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 12, type: '各停', destination: '金沢八景方面' },
      ],
    },
  ],
};

const tokyuKodomoData: LineTimetableData = {
  key: 'tokyuKodomoLine', name: '東急こどもの国線', ...KANTO_ADD,
  directions: [
    {
      label: '長津田→こどもの国',
      stations: [
        { name: '長津田', offset: 0 }, { name: '恩田', offset: 4 }, { name: 'こどもの国', offset: 8 },
      ],
      patterns: [
        { fromMin: m(6),     toMin: m(7),     intervalMin: 20, type: '各停', destination: 'こどもの国方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 10, type: '各停', destination: 'こどもの国方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 15, type: '各停', destination: 'こどもの国方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 12, type: '各停', destination: 'こどもの国方面' },
        { fromMin: m(20),    toMin: m(23),    intervalMin: 20, type: '各停', destination: 'こどもの国方面' },
      ],
    },
    {
      label: 'こどもの国→長津田',
      stations: [
        { name: 'こどもの国', offset: 0 }, { name: '恩田', offset: 4 }, { name: '長津田', offset: 8 },
      ],
      patterns: [
        { fromMin: m(6),     toMin: m(7),     intervalMin: 20, type: '各停', destination: '長津田方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 10, type: '各停', destination: '長津田方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 15, type: '各停', destination: '長津田方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 12, type: '各停', destination: '長津田方面' },
        { fromMin: m(20),    toMin: m(23),    intervalMin: 20, type: '各停', destination: '長津田方面' },
      ],
    },
  ],
};

const seibuChichibuData: LineTimetableData = {
  key: 'seibuChichibuLine', name: '西武秩父線', ...KANTO_ADD,
  directions: [
    {
      label: '吾野→西武秩父',
      stations: [
        { name: '吾野', offset: 0 }, { name: '東吾野', offset: 8 }, { name: '正丸', offset: 16 },
        { name: '芦ケ久保', offset: 26 }, { name: '横瀬', offset: 34 }, { name: '西武秩父', offset: 39 },
      ],
      patterns: [
        { fromMin: m(6),     toMin: m(9),     intervalMin: 30, type: '各停', destination: '西武秩父方面' },
        { fromMin: m(9),     toMin: m(17),    intervalMin: 30, type: '各停', destination: '西武秩父方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 30, type: '各停', destination: '西武秩父方面' },
        { fromMin: m(20),    toMin: m(23),    intervalMin: 40, type: '各停', destination: '西武秩父方面' },
      ],
    },
    {
      label: '西武秩父→吾野',
      stations: [
        { name: '西武秩父', offset: 0 }, { name: '横瀬', offset: 5 }, { name: '芦ケ久保', offset: 13 },
        { name: '正丸', offset: 23 }, { name: '東吾野', offset: 31 }, { name: '吾野', offset: 39 },
      ],
      patterns: [
        { fromMin: m(6),     toMin: m(9),     intervalMin: 30, type: '各停', destination: '飯能方面' },
        { fromMin: m(9),     toMin: m(17),    intervalMin: 30, type: '各停', destination: '飯能方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 30, type: '各停', destination: '飯能方面' },
        { fromMin: m(20),    toMin: m(23),    intervalMin: 40, type: '各停', destination: '飯能方面' },
      ],
    },
  ],
};

const tobuOgoseData: LineTimetableData = {
  key: 'tobuOgoseLine', name: '東武越生線', ...KANTO_ADD,
  directions: [
    {
      label: '坂戸→越生',
      stations: [
        { name: '坂戸', offset: 0 }, { name: '一本松', offset: 4 }, { name: '西大家', offset: 8 },
        { name: '川角', offset: 12 }, { name: '武州長瀬', offset: 17 }, { name: '東毛呂', offset: 22 },
        { name: '武州唐沢', offset: 27 }, { name: '越生', offset: 32 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 25, type: '各停', destination: '越生方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 15, type: '各停', destination: '越生方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 20, type: '各停', destination: '越生方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 15, type: '各停', destination: '越生方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 25, type: '各停', destination: '越生方面' },
      ],
    },
    {
      label: '越生→坂戸',
      stations: [
        { name: '越生', offset: 0 }, { name: '武州唐沢', offset: 5 }, { name: '東毛呂', offset: 10 },
        { name: '武州長瀬', offset: 15 }, { name: '川角', offset: 20 }, { name: '西大家', offset: 24 },
        { name: '一本松', offset: 28 }, { name: '坂戸', offset: 32 },
      ],
      patterns: [
        { fromMin: m(5),     toMin: m(7),     intervalMin: 25, type: '各停', destination: '坂戸方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 15, type: '各停', destination: '坂戸方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 20, type: '各停', destination: '坂戸方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 15, type: '各停', destination: '坂戸方面' },
        { fromMin: m(20),    toMin: m(24),    intervalMin: 25, type: '各停', destination: '坂戸方面' },
      ],
    },
  ],
};

const ryutetsuData: LineTimetableData = {
  key: 'ryutetsuLine', name: '流鉄流山線', ...KANTO_ADD,
  directions: [
    {
      label: '馬橋→流山',
      stations: [
        { name: '馬橋', offset: 0 }, { name: '幸谷', offset: 3 }, { name: '小金城趾', offset: 6 },
        { name: '鰭ヶ崎', offset: 9 }, { name: '平和台', offset: 12 }, { name: '流山', offset: 14 },
      ],
      patterns: [
        { fromMin: m(6),     toMin: m(7),     intervalMin: 20, type: '各停', destination: '流山方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 12, type: '各停', destination: '流山方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 15, type: '各停', destination: '流山方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 12, type: '各停', destination: '流山方面' },
        { fromMin: m(20),    toMin: m(23),    intervalMin: 20, type: '各停', destination: '流山方面' },
      ],
    },
    {
      label: '流山→馬橋',
      stations: [
        { name: '流山', offset: 0 }, { name: '平和台', offset: 2 }, { name: '鰭ヶ崎', offset: 5 },
        { name: '小金城趾', offset: 8 }, { name: '幸谷', offset: 11 }, { name: '馬橋', offset: 14 },
      ],
      patterns: [
        { fromMin: m(6),     toMin: m(7),     intervalMin: 20, type: '各停', destination: '馬橋方面' },
        { fromMin: m(7),     toMin: m(9, 30), intervalMin: 12, type: '各停', destination: '馬橋方面' },
        { fromMin: m(9, 30), toMin: m(17),    intervalMin: 15, type: '各停', destination: '馬橋方面' },
        { fromMin: m(17),    toMin: m(20),    intervalMin: 12, type: '各停', destination: '馬橋方面' },
        { fromMin: m(20),    toMin: m(23),    intervalMin: 20, type: '各停', destination: '馬橋方面' },
      ],
    },
  ],
};
...
export const timetableLines: LineTimetableData[] = [
  ...
  shinkeiseiData,
  toyoRapidData,
  // 第4弾追加路線（JR支線・伊豆箱根・千葉方面）
  jrHachikoLineData,
  jrItsukaichiLineData,
  jrItoLineData,
  izukyuLineData,
  hakoneTozanData,
  izuHakoneSunzuData,
