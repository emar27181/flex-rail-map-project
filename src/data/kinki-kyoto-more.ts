...
export const kyotoSubwayKarasuma: Station[] = [
  ...
  { name: "北山",               lat: 35.039400, lng: 135.773200, timeToNext: 3 },
  { name: "北大路",             lat: 35.029400, lng: 135.768200, timeToNext: 3 },
  { name: "鞍馬口",             lat: 35.022400, lng: 135.762200, timeToNext: 2 },
  { name: "今出川",             lat: 35.015900, lng: 135.756900, timeToNext: 2 },
...
export const kyotoSubwayTozai: Station[] = [
  ...
  { name: "東野",               lat: 34.978200, lng: 135.832400, timeToNext: 3 },
  { name: "椥辻",               lat: 34.972600, lng: 135.843100, timeToNext: 3 },
  { name: "小野",               lat: 34.966400, lng: 135.853800, timeToNext: 3 },
  { name: "醍醐",               lat: 34.960200, lng: 135.864400, timeToNext: 3 },
  { name: "石田",               lat: 34.954800, lng: 135.875600, timeToNext: 3 },
  { name: "六地蔵",             lat: 34.948200, lng: 135.875800, timeToNext: 0 },
];
...
export const keifukuArashiyama: Station[] = [
  ...
  { name: "山ノ内",             lat: 35.010400, lng: 135.724800, timeToNext: 2 },
  ...
  { name: "嵐電嵯峨",           lat: 35.017400, lng: 135.669200, timeToNext: 3 },
