...
export const kintetsuNaraLine2: Station[] = [
  ...
  { name: "東花園",    lat: 34.686430, lng: 135.641830, timeToNext: 3 },
  { name: "瓢箪山",    lat: 34.682910, lng: 135.648310, timeToNext: 3 },
  { name: "枚岡",      lat: 34.679060, lng: 135.668590, timeToNext: 3 },
  { name: "額田",      lat: 34.674180, lng: 135.678510, timeToNext: 3 },
  { name: "石切",      lat: 34.676040, lng: 135.684840, timeToNext: 4 },
...
export const kintetsuShimaLine: Station[] = [
  ...
  { name: "穴川",      lat: 34.362730, lng: 136.875870, timeToNext: 3 },
  { name: "上之郷",    lat: 34.362520, lng: 136.897660, timeToNext: 3 },
  { name: "志摩神明",   lat: 34.339640, lng: 136.883240, timeToNext: 3 },
  { name: "賢島",      lat: 34.318340, lng: 136.844880, timeToNext: 0 },
];

// 近鉄山田線: 伊勢中川〜宇治山田
export const kintetsuYamadaLine: Station[] = [
  { name: "伊勢中川",   lat: 34.714600, lng: 136.496600, timeToNext: 5 },
...
export const mizumaRailway: Station[] = [
  ...
  { name: "清児",      lat: 34.448300, lng: 135.397330, timeToNext: 3 },
  { name: "森",        lat: 34.447960, lng: 135.412960, timeToNext: 3 },
  { name: "三ヶ山口",   lat: 34.441230, lng: 135.424950, timeToNext: 3 },
  { name: "水間観音",   lat: 34.427870, lng: 135.435010, timeToNext: 0 },
];
...
export const kobeElecArimaLine: Station[] = [
  ...
  { name: "丸山",      lat: 34.708330, lng: 135.161570, timeToNext: 3 },
  { name: "鵯越",      lat: 34.721420, lng: 135.143480, timeToNext: 4 },
  { name: "鈴蘭台",    lat: 34.748010, lng: 135.145840, timeToNext: 4 },
  { name: "北鈴蘭台",   lat: 34.763760, lng: 135.147710, timeToNext: 4 },
  { name: "山の街",    lat: 34.780290, lng: 135.136560, timeToNext: 4 },
  { name: "箕谷",      lat: 34.805200, lng: 135.121510, timeToNext: 4 },
  { name: "谷上",      lat: 34.832250, lng: 135.149190, timeToNext: 4 },
  { name: "有馬口",    lat: 34.815240, lng: 135.241120, timeToNext: 4 },
...
export const eizanMainLine: Station[] = [
  ...
  { name: "三宅八幡",   lat: 35.083060, lng: 135.798350, timeToNext: 3 },
  { name: "八幡前",    lat: 35.088540, lng: 135.801230, timeToNext: 3 },
  { name: "岩倉",      lat: 35.090610, lng: 135.810570, timeToNext: 3 },
  { name: "木野",      lat: 35.093090, lng: 135.816040, timeToNext: 3 },
  { name: "二軒茶屋",   lat: 35.097080, lng: 135.823960, timeToNext: 4 },
  { name: "八瀬比叡山口", lat: 35.096080, lng: 135.844150, timeToNext: 0 },
];
