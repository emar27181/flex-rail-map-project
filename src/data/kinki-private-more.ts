...
export const sembokuKosokuLine: Station[] = [
  ...
  { name: "栂・美木多",  lat: 34.485057, lng: 135.490355, timeToNext: 4 },
  { name: "光明池",    lat: 34.474586, lng: 135.475334, timeToNext: 4 },
  { name: "和泉中央",   lat: 34.461323, lng: 135.456290, timeToNext: 0 },
];
...
export const nosedenMyokenLine: Station[] = [
  ...
  { name: "滝山",      lat: 34.842940, lng: 135.421165, timeToNext: 3 },
  ...
  { name: "笹部",      lat: 34.893763, lng: 135.416067, timeToNext: 4 },
  { name: "一畑口",    lat: 34.934990, lng: 135.408570, timeToNext: 4 },
  { name: "光風台",    lat: 34.900119, lng: 135.431648, timeToNext: 4 },
  { name: "ときわ台",   lat: 34.906020, lng: 135.437962, timeToNext: 4 },
  { name: "妙見口",    lat: 34.911591, lng: 135.444814, timeToNext: 0 },
];

// 京阪石山坂本線: 坂本比叡山口〜石山寺
export const keihanIshiyamasakamoto: Station[] = [
  { name: "坂本比叡山口", lat: 35.070502, lng: 135.871332, timeToNext: 3 },
  ...
  { name: "南草津",    lat: 35.003757, lng: 135.947264, timeToNext: 3 },
...
export const osakaMono: Station[] = [
  ...
  { name: "柴原阪大前",  lat: 34.800347, lng: 135.458675, timeToNext: 3 },
...
export const hanshinNamba: Station[] = [
  ...
  { name: "出来島",    lat: 34.707060, lng: 135.436970, timeToNext: 3 },
...
export const hankyuKobeLine2: Station[] = [
  ...
  { name: "園田",      lat: 34.751993, lng: 135.448093, timeToNext: 3 },
  ...
  { name: "御影",      lat: 34.714902, lng: 135.255586, timeToNext: 3 },
