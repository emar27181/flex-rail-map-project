...
export const stationTranslations: { [key: string]: string } = {
  ...
  "羽田空港国内線ターミナル": "Haneda Airport Terminal 1",
          ...
          "不動前": "Fudomae",  "武蔵小山": "Musashi-koyama",
  "西小山": "Nishi-koyama",
          "荏原町": "Ebara-machi",
          "戸越銀座": "Togoshi-ginza",
  "青物横丁": "Aomono-yokocho",
  ...
  "大鳥居": "Otorii",
      "穴守稲荷": "Anamori-inari",
      "羽田空港第1・第2ターミナル": "Haneda Airport Terminal 1&2",  "羽田空港第3ターミナル": "Haneda Airport Terminal 3",
  ...
  "三ツ境": "Mitsukyo",
      "瀬谷": "Seya",
      "相模大塚": "Sagami-otsuka",  "さがみ野": "Sagamino",
  "かしわ台": "Kashiwadai",
  "海老名": "Ebina",
  "厚木": "Atsugi",
  "本厚木": "Hon-atsugi",
  ...
  "鵜原": "Uhara",
    ...
    // 西武線の主要駅  "西武新宿": "Seibu-shinjuku",
  "高田馬場 (西武線)": "Takadanobaba (Seibu Line)",
      "下落合": "Shimo-ochiai",
      "中井 (西武線)": "Nakai (Seibu Line)",
      "新井薬師前": "Araiyakushi-mae",  "沼袋": "Numabukuro",
  "野方": "Nogata",
  "都立家政": "Toritsu-kasei",
  "鷺ノ宮": "Saginomiya",
  "下井草": "Shimo-igusa",
  ...
  "小平": "Kodaira",
      ...
      "航空公園": "Koku-koen",  "新所沢": "Shin-tokorozawa",
  "入曽": "Iriso",
  "狭山市": "Sayama-shi",
  "新狭山": "Shin-sayama",
  "南大塚": "Minami-otsuka",
  ...
  "参宮橋": "Sangubashi",
      ...
      "東北沢": "Higashi-kitazawa",  "下北沢": "Shimo-kitazawa",
